            ...
            <div class="flex__col">
                <div class="moving-images-wrap">
                    <div 
                        ...
                        class="moving-images"
                    >
                        <img class="moving-images__img" src="static/images/over_rice_chicken_platter.jpg" alt="">
                        <img class="moving-images__img" src="static/images/over_rice_lunch_combo.jpg" alt="">
                        <img class="moving-images__img" src="static/images/over_rice_lunch_combo.jpg" alt="">
                        <img class="moving-images__img" src="static/images/over_rice_chicken_platter.jpg" alt="">
                        <img class="moving-images__img" src="static/images/over_rice_lunch_combo.jpg" alt="">
                        <img class="moving-images__img" src="static/images/over_rice_chicken_platter.jpg" alt="">
                    ...
                    <div 
                        ...
                        class="moving-images"
                    >
                        <img class="moving-images__img" src="static/images/over_rice_chicken_kabab.jpg" alt="">
                        <img class="moving-images__img" src="static/images/over_rice_pork_bowl.jpg" alt="">
                        <img class="moving-images__img" src="static/images/over_rice_chicken_kabab.jpg" alt="">
                        <img class="moving-images__img" src="static/images/over_rice_chicken_kabab.jpg" alt="">
                        <img class="moving-images__img" src="static/images/over_rice_pork_bowl.jpg" alt="">
                        <img class="moving-images__img" src="static/images/over_rice_chicken_kabab.jpg" alt="">
